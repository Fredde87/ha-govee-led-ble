...
async def async_get_config_entry_diagnostics(
    ...
    coordinator_data = {
        ...
        # Which sync centre holds this device, if any.  Without it "the entity vanished"
        # and "the entity was handed to a DreamView centre" look identical in a report.
        "dreamview_owner_address": coordinator.dreamview_owner_address,
        "video_settings": {
